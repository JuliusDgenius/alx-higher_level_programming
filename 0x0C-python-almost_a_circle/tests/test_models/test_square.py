...
class TestSquare_instantiation(unittest.TestCase):
    ...
    def test_size_getter(self):
        with self.assertEqual(5, Square(5, 2, 3, 9).size)
...
class TestSquare_size(unittest.TestCase):
    """Unittests for testing size initializationof the Square class."""

    def test__None_size(self):
...
class TestSquare_y(unittest.TestCase):
    """Unittests for testing initialization of Sqaure y attribute."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Uniitests for testing order of Square attribute initialization."""
