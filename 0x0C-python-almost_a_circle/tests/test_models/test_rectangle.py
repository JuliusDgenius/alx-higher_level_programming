...
class TestRectangle_height(unittest.TestCase):
    ...
    def test_None_height(self):
        with self.assertRaisesRegex(TypeError, "height must be an integer"):            Rectangle(1, None)

    def test_str_height(self):
        with self.assertRaisesRegex(TypeError, "height must be an integer"):            Rectangle(1, "invalid")
...
class TestRectangle_area(unittest.TestCase):
    ...
    def test_area_changed_attributes(self):
        r = Rectangle(2, 10, 1, 1, 1)                                               r.width = 7
        r.height = 14
...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_three(self):
        r = Rectangle(10, 10, 10, 10, 10)                                           r.update(89, 2, 3)
    ...
    def test_update_args_invalid_width_type(self):
        r = Rectangle(10, 10, 10, 10, 10)                                           with self.assertRaisesRegex(TypeError, "width must be an integer"):
        r.update(89, "invalid")
...
class TestRectangle_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_wrong_keys(self):
        r = Rectangle(10, 10, 10, 10, 10)                                                                                                                                       r.update(a=5, b=10)
        self.assertEqual("[Rectangle] (10) 10/10 - 10/10", str(r))
